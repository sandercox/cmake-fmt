...
export class CMakeFormattingProvider implements vscode.DocumentFormattingEditProvider {
  public async provideDocumentFormattingEdits(
    ...
    try {
      const formattedText = await this.formatDocument(document, token);
      ...
      this.handleError(error, document.fileName);
      return [];
    }
  }
  ...
  private async formatDocument(
    ...
    return new Promise((resolve, reject) => {
      ...
      // Spawn cmake-fmt with stdin and --assume-filename
  ...
  private handleError(error: any, fileName: string): void {
