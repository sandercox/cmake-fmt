...
/// Returns true if `name_lower` (already lowercased) is a CMake builtin command.
pub fn is_builtin_command(name_lower: &str) -> bool {
    matches!(
        name_lower,
        // Scripting commands
        "block"
            ...
            | "ctest_update"
            | "ctest_upload"
            // Deprecated commands (still recognized as builtins)
            | "build_name"
            | "exec_program"
